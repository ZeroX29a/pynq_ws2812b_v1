...
proc create_root_design { parentCell } {
  ...
  # Create instance: lighting_0, and set properties
  set block_name lighting
  set block_cell_name lighting_0
  if { [catch {set lighting_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $lighting_0 eq "" } {
...
Flash#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned} \
...
unassigned#qspi0_ss_b#qspi0_io[0]#qspi0_io[1]#qspi0_io[2]#qspi0_io[3]/HOLD_B#qspi0_sclk#unassigned#qspi_fbclk#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned} \
  ...
  # Create instance: refresh, and set properties
  set refresh [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 refresh ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {24} \
   CONFIG.DIN_TO {24} \
   CONFIG.DIN_WIDTH {25} \
  ...
  connect_bd_net -net blue_Dout [get_bd_pins blue/Dout] [get_bd_pins lighting_0/blu]
  connect_bd_net -net clk_1 [get_bd_ports clk] [get_bd_pins lighting_0/clk]
  connect_bd_net -net enable_1 [get_bd_ports enable] [get_bd_pins lighting_0/enable]
  connect_bd_net -net green_Dout [get_bd_pins green/Dout] [get_bd_pins lighting_0/gre]
  connect_bd_net -net lighting_0_Dout [get_bd_ports Dout] [get_bd_pins lighting_0/Dout]
  connect_bd_net -net processing_system7_0_GPIO_O [get_bd_pins blue/Din] [get_bd_pins green/Din] [get_bd_pins processing_system7_0/GPIO_O] [get_bd_pins red/Din] [get_bd_pins refresh/Din]
  connect_bd_net -net red_Dout [get_bd_pins lighting_0/red] [get_bd_pins red/Dout]
  connect_bd_net -net refresh_Dout [get_bd_pins lighting_0/refresh_led] [get_bd_pins refresh/Dout]
