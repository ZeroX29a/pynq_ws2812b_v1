...
--        spexify : in unsigned(7 downto 0);
...
--    signal color: unsigned(23 downto 0) := "111111111111111111111111";
--    signal color_s: unsigned(23 downto 0) := "000000000000000000000000"; --specific led marker color
...
--    signal marker: integer := to_integer(spexify);
--begin
...
--                if colour_counter = marker and marker < 24 then   -- mark specific LED
--                    vram(to_integer(colour_counter)+write_addr) <= color_s;
--                else
--                    vram(to_integer(colour_counter)+write_addr) <=  color;
--                end if;
        ...
        if rising_edge(clk) and enable ='1' then
            ...
            if colour_counter >= size then
                ...
                if spexify < 24 then
                    ...
                    if colour_counter = to_integer(spexify)  then   -- mark specific LED
                        vram(to_integer(colour_counter)+write_addr) <= color_s;
                    else
                        vram(to_integer(colour_counter)+write_addr) <=  "000000000000000000000000";
                    end if;
